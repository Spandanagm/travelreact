          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  "Explore all corners of the world with us! Discover breathtaking landscapes, vibrant cultures, and hidden gems. From the peaks of the Himalayas to the beaches of the Maldives, we offer tailored travel experiences that cater to your sense of adventure. Join us for unforgettable journeys that create lasting memories!"
                  <br />
                </p>
